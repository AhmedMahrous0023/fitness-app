        ...
        body: Container(
          child: Column(
            children: [
             ...
             CustomRowRadio(value: 'Standard',text: 'Standard',description: "I'm easy", groupValue: selectedOption,onChanged: (value){
              if(value!=null){
                setState(() {
             ...
             CustomRowRadio(value: 'Vegetarian',text: 'Vegetarian', description: 'No meat or fish',groupValue: selectedOption,onChanged: (value){
              if(value!=null){
                setState(() {
                  selectedOption=value ;
                });
             ...
             SizedBox(
              ...
              CustomRowRadio(value: 'Vegan',text: 'Vegan', description: 'No animal products',groupValue: selectedOption,onChanged: (value){
              if(value!=null){
                setState(() {
                  selectedOption=value ;
                });
            ...
            GestureDetector(
              onTap: (){
                if(selectedOption!=''){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>KindOfRecipes()));
                }
                else{
                  ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('You should choose the type of your diet'),
