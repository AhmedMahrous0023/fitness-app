        ...
        child: Container(
          child: Column(
            children: [
                    ...
                    itemBuilder: (context, index) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 18,color:OfflineDataBase.recipesKind[index].selected?Colors.green:   Colors.white ,shadows: [
                            Shadow(
                              color: Colors.grey,
                              blurRadius: 1,
                            ),
                    ...
                    itemBuilder: (context, index) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 18, color:OfflineDataBase.preferredVegtables[index].selected?Colors.green:   Colors.white ,shadows: [
                            Shadow(
                              color: Colors.grey,
                              blurRadius: 1,
                            ),
                    ...
                    itemBuilder: (context, index) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 18,color: OfflineDataBase.preferedFruits[index].selected?Colors.green:  Colors.white , shadows: [
                            Shadow(
                              color: Colors.grey,
                              blurRadius: 1,
                            ),
                    ...
                    itemBuilder: (context, index) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 18,color: OfflineDataBase.ingredients[index].selected?Colors.green:  Colors.white , shadows: [
                            Shadow(
                              color: Colors.grey,
                              blurRadius: 1,
                            ),
                    ...
                    itemBuilder: (context, index) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 18, color:OfflineDataBase.preferedBreakfast[index].selected?Colors.green:   Colors.white ,shadows: [
                            Shadow(
                              color: Colors.grey,
                              blurRadius: 1,
                            ),
                    ...
                    itemBuilder: (context, index) {
                      return CheckboxListTile(
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 18,color: OfflineDataBase.preferedMainCoures[index].selected?Colors.green:  Colors.white , shadows: [
                            Shadow(
                              color: Colors.grey,
                              blurRadius: 1,
                            ),
              ...
              GestureDetector(
                onTap: () {
                  if(OfflineDataBase.selectedRecipes.isNotEmpty&&OfflineDataBase.selectedBreakfast.isNotEmpty&&OfflineDataBase.selectedVegtables.isNotEmpty&&OfflineDataBase.selectedFruits.isNotEmpty&&OfflineDataBase.selectedIngredients.isNotEmpty&&OfflineDataBase.selectedMainCourse.isNotEmpty&&OfflineDataBase.selectedDesserts.isNotEmpty){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>AnyDiseasesScreen()));
                  }else {
                     ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('You should select one answer at least to every question!'),
